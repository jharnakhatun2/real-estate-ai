export default function WhyShoud() {
  ...
  <div className="container px-6 py-8 lg:py-20 mx-auto">
    <h1 className="text-2xl lg:text-5xl font-semibold text-center text-gray-800 capitalize dark:text-white">
    Why property valuation by Us?
    </h1>
    <p className="max-w-2xl mx-auto mt-4 text-center text-gray-500 xl:mt-6 dark:text-gray-300">
    AI-generated property listings provide a more efficient, accurate, and personalized experience for both real estate professionals and property seekers, improving the effectiveness of the property market as a whole
    </p>
    <div className="grid grid-cols-1 gap-8 mt-12 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-stopwatch text-[#5387d4]" viewBox="0 0 16 16"> <path d="M8.5 5.6a.5.5 0 1 0-1 0v2.9h-3a.5.5 0 0 0 0 1H8a.5.5 0 0 0 .5-.5V5.6z"/> <path d="M6.5 1A.5.5 0 0 1 7 .5h2a.5.5 0 0 1 0 1v.57c1.36.196 2.594.78 3.584 1.64a.715.715 0 0 1 .012-.013l.354-.354-.354-.353a.5.5 0 0 1 .707-.708l1.414 1.415a.5.5 0 1 1-.707.707l-.353-.354-.354.354a.512.512 0 0 1-.013.012A7 7 0 1 1 7 2.071V1.5a.5.5 0 0 1-.5-.5zM8 3a6 6 0 1 0 .001 12A6 6 0 0 0 8 3z"/> </svg>
        <h1 className="capitalize mt-4 text-xl font-semibold text-gray-800 dark:text-white">
        Automation & Save Time
        </h1>
        <p className="mt-2 text-gray-500 dark:text-gray-400">
        AI automates data collection & analysis, expediting property valuation. It saves time, improves accuracy, and enhances efficiency.
        </p>
      </div>
      <div>
      <svg className="w-8 h-8" viewBox="0 0 30 30" fill="none">
        ...
        <p className="mt-2 text-gray-500 dark:text-gray-400">
        Our streamlines property valuation with efficiency, advanced algorithms and boost productivity with ensure accurate valuations.
        </p>
      </div>
      <div>
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-list-stars text-[#5387d4]" viewBox="0 0 16 16"> <path fillRule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5z"/> <path d="M2.242 2.194a.27.27 0 0 1 .516 0l.162.53c.035.115.14.194.258.194h.551c.259 0 .37.333.164.493l-.468.363a.277.277 0 0 0-.094.3l.173.569c.078.256-.213.462-.423.3l-.417-.324a.267.267 0 0 0-.328 0l-.417.323c-.21.163-.5-.043-.423-.299l.173-.57a.277.277 0 0 0-.094-.299l-.468-.363c-.206-.16-.095-.493.164-.493h.55a.271.271 0 0 0 .259-.194l.162-.53zm0 4a.27.27 0 0 1 .516 0l.162.53c.035.115.14.194.258.194h.551c.259 0 .37.333.164.493l-.468.363a.277.277 0 0 0-.094.3l.173.569c.078.255-.213.462-.423.3l-.417-.324a.267.267 0 0 0-.328 0l-.417.323c-.21.163-.5-.043-.423-.299l.173-.57a.277.277 0 0 0-.094-.299l-.468-.363c-.206-.16-.095-.493.164-.493h.55a.271.271 0 0 0 .259-.194l.162-.53zm0 4a.27.27 0 0 1 .516 0l.162.53c.035.115.14.194.258.194h.551c.259 0 .37.333.164.493l-.468.363a.277.277 0 0 0-.094.3l.173.569c.078.255-.213.462-.423.3l-.417-.324a.267.267 0 0 0-.328 0l-.417.323c-.21.163-.5-.043-.423-.299l.173-.57a.277.277 0 0 0-.094-.299l-.468-.363c-.206-.16-.095-.493.164-.493h.55a.271.271 0 0 0 .259-.194l.162-.53z"/> </svg>
        <h1 className="capitalize mt-4 text-xl font-semibold text-gray-800 dark:text-white">
        multiple listings
        </h1>
        <p className="mt-2 text-gray-500 dark:text-gray-400">
        We generate multiple property rapidly. Users benefit from a wide selection, quick access, and accurate information.
        </p>
      </div>
    </div>
  </div>
