  ...
  return (
    <section>
      <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
        <img className="object-cover w-full lg:mx-6 lg:w-2/5 rounded-xl h-72 lg:h-52" src={image} alt="" />
        ...
        <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
          ...
          <a href="#" className="block mt-3 text-2xl font-semibold text-gray-800 hover:underline dark:text-white">
            {title}
          </a>
