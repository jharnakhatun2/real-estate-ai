      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 px-10">
        ...
        <div className="">
          <div tabIndex={0} className="collapse collapse-arrow border border-base-300  rounded-box mb-5 ">
            <div className="collapse-title text-xl font-medium bg-[#d8b4fe]">What is a real estate AI product?</div>
          ...
          <div tabIndex={0} className="collapse collapse-arrow border border-base-300  rounded-box mb-5 ">
            <div className="collapse-title text-xl font-medium bg-[#d8b4fe]">
